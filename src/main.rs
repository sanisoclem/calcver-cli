...
use calcver::project::{ProjectBuilder,Project};
...
fn main() {
    ...
    let proj = Project::from("D:\\Workspace_V2\\src\\github.com\\easy-semvder\\calcver-cli").finalize();
    let version = calcver::get_version(&proj,VersionBumpBehavior::Auto,false).expect("something");
    println!("{}",version);
}